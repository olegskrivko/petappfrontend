  ...
  return (
    <React.Fragment>
      ...
      <Typography variant="body1" paragraph>
        Our app utilizes advanced technology to facilitate the reunification of
        lost pets with their owners. We provide a platform for posting lost pet
        listings and actively work to connect owners with individuals who have
        found them.
      </Typography>
      <Typography variant="body1" paragraph>
        Additionally, our app connects you with a wide range of pet-related
        services, including veterinary clinics, groomers, trainers, and more. We
        ensure that you have access to the right resources for your pet's
        specific needs.
      </Typography>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6} textAlign="center">
          <Card style={{ backgroundColor: "#1D1D1D", color: "#fff" }}>
            <CardContent>
              ...
              <Typography>
                Your contribution can help us continue our mission to reunite
                lost pets with their families and provide them with the care
                they need. Every little bit counts and we appreciate your
                support!
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={6} lg={6} textAlign="center">
          <Card style={{ backgroundColor: "#f8f9fa", color: "#000" }}>
            <CardContent>
              ...
              <Typography>
                Your feedback is valuable to us as we strive to improve our app
                and provide the best service to pet owners. Please share any
                comments, suggestions, or criticisms to help us make our app
                even better.
              </Typography>
