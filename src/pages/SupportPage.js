      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={12} md={6} lg={6} textAlign="justify">
          <Typography variant="body1" paragraph>
            We are grateful for any support or sponsorship that can help us
            unlock the full potential of our web application. If you share our
            vision and would like to contribute towards the cost of utilizing
            premium tiers and services, please reach out to us.
          </Typography>
          <Typography variant="body1" paragraph>
            Your support will enable us to enhance our app and provide an even
            better experience for our users.
          </Typography>
          <Grid item xs={12} sm={12} md={12} lg={12} textAlign="center">
            <Button style={{ backgroundColor: "#ffc107", color: "#000" }}>
              Donate
            </Button>
          </Grid>
        </Grid>
